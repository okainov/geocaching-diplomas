...
def get_region_neighbours(region):
    ...
    ########################################## УФО ##########################################
    elif region == 'Россия, Курганская обл.':
        return ['Россия, Свердловская обл.', 'Россия, Тюменская обл.', 'Россия, Челябинская обл.']
    elif region == 'Россия, Свердловская обл.':
        return ['Россия, Башкортостан респ.', 'Россия, Коми респ.', 'Россия, Пермский край',
                'Россия, Курганская обл.', 'Россия, Тюменская обл.', 'Россия, Челябинская обл.']
    elif region == 'Россия, Тюменская обл.':
        return ['Россия, Коми респ.', 'Россия, Красноярский край', 'Россия, Курганская обл.',
                'Россия, Омская обл.', 'Россия, Свердловская обл.', 'Россия, Томская обл.',
                'Россия, Архангельская обл.']
    elif region == 'Россия, Челябинская обл.':
        return ['Россия, Башкортостан респ.', 'Россия, Курганская обл.',
                'Россия, Оренбургская обл.', 'Россия, Свердловская обл.']
    ########################################## CФО ##########################################
    elif region == 'Россия, Алтай респ.':
        return ['Россия, Тыва (Тува) респ.', 'Россия, Хакасия респ.',
                'Россия, Алтайский край', 'Россия, Кемеровская обл.']
    elif region == 'Россия, Бурятия респ.':
        return ['Россия, Тыва (Тува) респ.', 'Россия, Забайкальский край', 'Россия, Иркутская обл.']
    elif region == 'Россия, Тыва (Тува) респ.':
        return ['Россия, Алтай респ.', 'Россия, Бурятия респ.', 'Россия, Хакасия респ.',
                'Россия, Красноярский край', 'Россия, Иркутская обл.']
    elif region == 'Россия, Хакасия респ.':
        return ['Россия, Алтай респ.', 'Россия, Тыва (Тува) респ.',
                'Россия, Красноярский край', 'Россия, Кемеровская обл.']
    elif region == 'Россия, Алтайский край':
        return ['Россия, Алтай респ.', 'Россия, Кемеровская обл.', 'Россия, Новосибирская обл.']
    elif region == 'Россия, Забайкальский край':
        return ['Россия, Бурятия респ.', 'Россия, Саха (Якутия) респ.',
                'Россия, Амурская обл.', 'Россия, Иркутская обл.']
    elif region == 'Россия, Красноярский край':
        return ['Россия, Саха (Якутия) респ.', 'Россия, Тыва (Тува) респ.', 'Россия, Хакасия респ.',
                'Россия, Иркутская обл.', 'Россия, Кемеровская обл.', 'Россия, Томская обл.',
                'Россия, Тюменская обл.']
    elif region == 'Россия, Иркутская обл.':
        return ['Россия, Бурятия респ.', 'Россия, Саха (Якутия) респ.', 'Россия, Тыва (Тува) респ.',
                'Россия, Забайкальский край', 'Россия, Красноярский край']
    elif region == 'Россия, Кемеровская обл.':
        return ['Россия, Алтай респ.', 'Россия, Хакасия респ.', 'Россия, Алтайский край',
                'Россия, Красноярский край', 'Россия, Новосибирская обл.', 'Россия, Томская обл.']
    elif region == 'Россия, Новосибирская обл.':
        return ['Россия, Алтайский край', 'Россия, Кемеровская обл.', 'Россия, Омская обл.',
                'Россия, Томская обл.']
    elif region == 'Россия, Омская обл.':
        return ['Россия, Новосибирская обл.', 'Россия, Томская обл.', 'Россия, Тюменская обл.']
    elif region == 'Россия, Томская обл.':
        return ['Россия, Красноярский край', 'Россия, Кемеровская обл.', 'Россия, Новосибирская обл.',
                'Россия, Омская обл.', 'Россия, Тюменская обл.', ]
    ########################################## ДвФО ##########################################
    elif region == 'Россия, Саха (Якутия) респ.':
        return ['Россия, Забайкальский край', 'Россия, Красноярский край', 'Россия, Хабаровский край',
                'Россия, Амурская обл.', 'Россия, Иркутская обл.', 'Россия, Магаданская обл.',
                'Россия, Чукотский авт. окр.']
    elif region == 'Россия, Камчатский край':
        return ['Россия, Магаданская обл.', 'Россия, Сахалинская обл.', 'Россия, Чукотский авт. окр.']
    elif region == 'Россия, Приморский край':
        return ['Россия, Хабаровский край']
    elif region == 'Россия, Хабаровский край':
        return ['Россия, Саха (Якутия) респ.', 'Россия, Приморский край', 'Россия, Амурская обл.',
                'Россия, Магаданская обл.', 'Россия, Сахалинская обл.', 'Россия, Еврейская авт. обл.']
    elif region == 'Россия, Амурская обл.':
        return ['Россия, Саха (Якутия) респ.', 'Россия, Забайкальский край', 'Россия, Хабаровский край',
                'Россия, Еврейская авт. обл.']
    elif region == 'Россия, Магаданская обл.':
        return ['Россия, Саха (Якутия) респ.', 'Россия, Камчатский край', 'Россия, Хабаровский край',
                'Россия, Чукотский авт. окр.']
    elif region == 'Россия, Сахалинская обл.':
        return ['Россия, Камчатский край', 'Россия, Хабаровский край', 'Россия, Приморский край']
    elif region == 'Россия, Еврейская авт. обл.':
        return ['Россия, Хабаровский край', 'Россия, Амурская обл.']
    elif region == 'Россия, Чукотский авт. окр.':
        return ['Россия, Саха (Якутия) респ.', 'Россия, Камчатский край', 'Россия, Магаданская обл.']
